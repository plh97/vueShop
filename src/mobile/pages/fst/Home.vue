<template>
	<div class="goodslist">
		...
		<mt-swipe :auto="4000">
			<mt-swipe-item>
				<img src="@/assets/images/fst/f1.png" />
			</mt-swipe-item>
			<mt-swipe-item>
				<img src="@/assets/images/fst/f2.png" />
			</mt-swipe-item>
			<mt-swipe-item>
				<img src="@/assets/images/fst/f3.png" />
			</mt-swipe-item>
		</mt-swipe>
			<div class="head-nav">
			<ul>
...
export default {
	...
	computed: {
		home: ()=> {
			console.log('computed: home')
			return store.state.home.slice(0,4)
		},
		home1: ()=> {
			console.log('computed: home1')
			return store.state.home1.slice(0,4);
		},
	},
	created() {
		store.commit('home');
