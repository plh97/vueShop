...
var data = Mock.mock(/api\/fst1$/, {
  code: 1,
  msg: '获取成功.',
  'rows|5-16': [{
    'id|+1': 66141,
    'goods_image': Random.image('500x500', '@color', 'fst1'),
    'goods_image_list|1-5': [ Random.image('500x500', '@color', 'fst1 系列') ],
    'new_price': 0.0,
    'goods_name': '法塞特2011霜后赤霞珠干红葡萄酒 750ml',
    'goods_code|+23': Number('010002011'),
    'goods_short_name': '',
    'brand_id|+1': 19,
    'brand_name': '法塞特',
