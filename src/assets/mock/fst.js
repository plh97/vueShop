...
var data = Mock.mock(/api\/fst$/, {
  code: 1,
  msg: '获取成功.',
  'rows|5-16': [{
    'id|+1': 66141,
    'goods_image': Random.image('500x500', '@color', 'fst'),
    'goods_image_list|1-5': [ Random.image('500x500', '@colorful', 'fst list1') ],
    'new_price': 0.0,
    'goods_name': '法塞特2011霜后赤霞珠干红葡萄酒 750ml',
    'goods_code|+54': Number('010001005'),
    'goods_short_name': '',
    'brand_id|+1': 19,
    'brand_name': '法塞特',
